#!/usr/bin/env bash
# test-smoke.sh — integration smoke test for the backup bash workers.
#
...
echo "${SMOKE_RECIPIENT}" > "${SMOKE_RECIPIENTS_DIR}/recovery.txt"
...
export MYFINANCE_BACKUP_HEALTHCHECKS_URL=""
