...
> **No usar.** Este skill promueve microservicios, Clean Architecture por capas, JPA/Hibernate y WebFlux reactivo — contradice las decisiones del [`SPEC.md`](../../../SPEC.md): monolito modular **por dominio**, **jOOQ** (no JPA), sin reactivo. Se conserva como referencia histórica.
