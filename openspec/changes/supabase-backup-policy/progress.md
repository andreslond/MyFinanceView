...
current_task: "1.1"
last_completed: "7.7"
next_step: "Operator §1 prereqs — install age on Windows PC, generate single primary identity, configure R2 token + 5 lifecycle policies + Gmail App Password + ntfy topic + Kuma push URL + Supabase role password + runner shared secret"
...
# - tasks.md 8.4a added — operator step to re-link errorWorkflow dropdown after import in each of Daily/PreOp/Watchdog (Major M3 documented 2026-06-01).
