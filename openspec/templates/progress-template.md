<!--
  ...
  prose, no markdown headings outside HTML comments. A future ConvertFrom-Yaml
  (PowerShell 7) or yaml.safe_load (Python) must be able to parse it in one
  call without regex gymnastics.
